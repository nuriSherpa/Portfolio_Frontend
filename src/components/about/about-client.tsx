        ...
        <div className="w-full flex justify-center">
          <div className="w-[80%] max-w-6xl">
            <div className="space-y-12">
                  ...
                  <div className="flex flex-col md:flex-row gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                    ...
                    <div className="flex-1 text-center md:text-left">
                      <div className="flex flex-col md:flex-row md:items-start justify-between gap-3 sm:gap-4">
                        ...
                        {/* Social Icons - Adjusted mobile sizing and spacing */}
                        {about.socialMediaLinks &&
                          Object.keys(about.socialMediaLinks).length > 0 && (
                      ...
                      {/* Buttons - Adjusted mobile sizing */}
              ...
              {about.worksFor?.name && (
                <div className="bg-white shadow-sm p-4 sm:p-5 md:p-6">
                  <div className="flex items-center gap-2 mb-3 sm:mb-4">
                    ...
                    <h2 className="text-base sm:text-lg font-semibold text-grey-900">
                      Current Work
                    </h2>
                  </div>
              ...
              {/* Experience Card - LinkedIn Style Horizontal Layout */}
              {about.experiences.length > 0 && (
                <div className="bg-white shadow-sm p-4 sm:p-5 md:p-6">
                  ...
                  {/* Horizontal grid: 1 col mobile, 2 col tablet, 3 col desktop */}
                    ...
                    {about.experiences.map((exp) => (
                      <div key={exp._id} className="flex gap-3 sm:gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {/* Date below title - LinkedIn style */}
                          ...
                          {exp.location && (
                            <p className="text-xs text-grey-400 mt-0.5">{exp.location}</p>
                          )}
                        </div>
                      </div>
                    ))}
              ...
              {/* Education Card - LinkedIn Style Horizontal Layout */}
              ...
              {/* Certifications Card - LinkedIn Style with better responsive width */}
              {about.certifications.length > 0 && (
                <div className="bg-white shadow-sm p-4 sm:p-5 md:p-6">
                  ...
                  {/* Responsive grid: 1 col mobile, 2 col tablet+, better constrained width */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    {about.certifications.map((cert) => (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex gap-3 p-3 border border-grey-200 hover:border-red hover:shadow-sm transition-all rounded-sm"
                      >
                        {/* Logo - no background, slightly smaller */}
                        {cert.logo && (
                ...
                <div className="bg-white shadow-sm p-4 sm:p-5 md:p-6">
                  ...
                  <div className="flex flex-wrap gap-1 sm:gap-2">
                    {about.languages.map((lang) => (
                      ...
                      >
                        <span className="font-medium text-grey-700 text-xs sm:text-sm">
                          {lang.name}
                        </span>
                        <span
